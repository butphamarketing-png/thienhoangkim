...
export function LuckyWheelFloatingIcon({ onClick }: Props) {
  ...
  return (
    <motion.button
      type="button"
      onClick={onClick}
      className="fixed bottom-28 left-4 z-[9998] flex h-14 w-14 flex-col items-center justify-center rounded-full border-2 border-[#c9a227] bg-gradient-to-br from-[#d4efe6] to-[#b8e4d4] shadow-[0_12px_32px_rgba(26,80,60,0.2)] focus:outline-none sm:bottom-8 sm:left-6 md:bottom-10 md:left-8"
      animate={{ y: [0, -8, 0] }}
